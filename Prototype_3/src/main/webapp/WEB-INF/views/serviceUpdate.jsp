...
<form action="saveService" method="Post" modelAttribute="service">
  <div class="container">
    ...
    <input id=serviceId type="hidden" value="${service.id}" name="id" required>
 	
    <label for="name"><b>Name</b></label>
    <input id=nameId type="text"  placeholder="Enter Medical Service Name" value="${service.name}" name="name"  required  >
 
   <label for="description"><b>Description</b></label>
    <input id=descriptionId type="text"  placeholder="Enter Description" value="${service.description}" name="description"  required  >
