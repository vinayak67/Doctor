...
<nav class="navbar navbar-default"  style="background-color:#EFEDEA; width:600px;" >
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      <a class="navbar-brand" href="/demo/service/listServices" style="background-color: #C1BFBC ; margin-left:0px ;width: auto ; text-align: center ;">Medical Services</a>
    </div>
  </div>
</nav>
 ...
 <nav>
      ...
      ${service.name}</span></h4>
 </nav>      
  </section> 
  <section> 
  <h4 class="price" ><span>ID : </span><span >${service.id}</span></h4>
        
            
  <h4 class="description"><span><c:out value="${'Description :' }"></c:out></span> <span >${service.description}</span></h4>
   
    <h4 class="rating"><span><c:out value="${'Amount :' }"></c:out></span> <span >${service.amount}</span></h4>        
</section>
</div>
      </div>
    </div>
