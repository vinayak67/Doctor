...
public class CheckupRequest {
	...
	public CheckupRequest(int id, int cid, String did, int medicare_service_ID, Date service_date, Date result_date,
			String status, int d1_actual, int d1_normal, int d2_actual, int d2_normal, String comment,
			String other_info) {
		super();
		this.id = id;
		this.cid = cid;
